    ...
    <header className="bg-gradient-to-r from-[#ffe1e7] to-[#fff5f7] border-b border-[#ffabbb]/20 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          {/* Cart Button - Right */}
          <button className="relative p-2 sm:p-3 rounded-full bg-white/80 hover:bg-[#ffabbb] text-[#ff8a9f] hover:text-white transition-all duration-300 transform hover:scale-110 active:scale-95 group shadow-lg">
