    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-[#fff5f7] via-[#fffafd] to-[#ffe1e7] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-[#ffabbb]/20">
            {/* Table Header */}
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div className="bg-white/10 rounded-2xl p-6">
                  ...
                  <h4 className="text-xl font-bold mb-2">Regular Clips</h4>
                  <p className="text-pink-100">Break • Hurt • Dangerous • Limited</p>
                </div>
                <div className="bg-white/20 rounded-2xl p-6 border-2 border-white/30">
                  <div className="text-4xl mb-3">✨</div>
                  <h4 className="text-xl font-bold mb-2">JellyClip</h4>
                  <p className="text-pink-100">Unbreakable • Comfortable • Safe • Stylish</p>
                </div>
              </div>
